...
print('Coefficients: \n', regr.coef_)
print("MSE Train: ", mean_squared_error(Y_pred2,Y_train, squared=True))
print("R^2 Train: ", r2_score(Y_pred2,Y_train))
print("MSE Test: ", mean_squared_error(Y_pred1,Y_test, squared=True))
print("R^2 Test: ", r2_score(Y_pred1,Y_test))

# Print Plot of Outputs
figure1, ax = plt.subplots()
figure2, ax2 = plt.subplots()
ax.plot(Y_test, color='black', markersize=5)
ax.plot(Y_pred1, color='magenta', markersize=5)
ax2.plot(Y_train, color='red', markersize=5)
ax2.plot(Y_pred2, color='cyan', markersize=5)
plt.show()
